...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        # add G_NLL
        self.loss_names = ['G_GAN', 'G_L1', 'G_NLL', 'D_real', 'D_fake']
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        self.visual_names = ['real_A', 'fake_mean', 'fake_scale', 'real_B']
    ...
    def backward_D(self):
        ...
        fake_AB = torch.cat((self.real_A, self.fake_mean), 1)  # Use only mean for D
    ...
    def backward_G(self):
        ...
        fake_AB = torch.cat((self.real_A, self.fake_mean), 1)
        ...
        self.loss_G_L1 = self.criterionL1(self.fake_mean, self.real_B) * self.opt.lambda_L1
